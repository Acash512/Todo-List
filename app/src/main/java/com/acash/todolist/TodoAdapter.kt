...
class TodoAdapter(private var list:List<TodoModel>,private val context:Context): RecyclerView.Adapter<TodoAdapter.TodoViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TodoViewHolder {
        val itemView=LayoutInflater.from(parent.context).inflate(R.layout.list_item_todo,parent,false)
